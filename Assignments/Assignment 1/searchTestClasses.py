...
class CapsuleTest(testClasses.TestCase):
    ...
    def __init__(self, question, testDict):
        ...
        self.searchProblemClassName = "CapsuleSearchProblem"
        self.heuristicName = "capsuleProblemHeuristic"


    # def solution(self, searchAgents, grades,moduleDict):
    #     lay = layout.Layout([l.strip() for l in self.layoutText.split('\n')])
    #     import textDisplay
    #     gameDisplay = textDisplay.NullGraphics()

    #     # import graphicsDisplay
    #     # gameDisplay = graphicsDisplay.PacmanGraphics(1, frameTime=.5)    
    #     #     
    #     #gameState = pacman.GameState()
    #     #gameState.initialize(lay, 0)
    ...
    #     noKeyboard = True
    #     pacmanType = pacman.loadAgent('CapsuleSearchAgent', noKeyboard)
    #     # ghostType =pacman.loadAgent('DummyGhost',noKeyboard)
    #     agentOpts = pacman.parseAgentArgs('fn=astar,prob=CapsuleSearchProblem,heuristic=capsuleProblemHeuristic')
    #     mypacman = pacmanType(**agentOpts) # Instantiate Pacman with agentArgs
    #     # myghost = ghostType(0)
    #     # game = rules.newGame( lay, mypacman, [myghost], gameDisplay, True, False, True)
    #     game = rules.newGame( lay, mypacman, [], gameDisplay, True, False, False)
    #     import time
    ...
    #     exp_nodes= game.agents[0].searchType._expanded
    #     print(exp_nodes)
    #     grades.addPoints(self.basePoints)
    #     points = 0
    #     if game.state.isWin():
